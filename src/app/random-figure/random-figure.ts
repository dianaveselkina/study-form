...
export class RandomFigure implements OnInit, OnDestroy {
  images: ImageItem[] = [
    ...
    { src: 'assets/figure1.png', class: 'figure figure-size' },
    { src: 'assets/figure2.png', class: 'figure figure-size' },
    { src: 'assets/figure3.png', class: 'figure figure-size' },
    { src: 'assets/figure4.png', class: 'figure figure-size' },
  ];
